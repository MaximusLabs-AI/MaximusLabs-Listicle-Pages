    ...
    <div>
      ...
      <main className="wrap" id="directory">
        <header className="masthead">
          <div className="crumbs"><nav className="page-breadcrumbs" aria-label="Breadcrumb"><a href="/">{template.publisherName || page.publisherName || 'MaximusLabs.ai'}</a><span aria-hidden="true">/</span><a href="/blog">Resources</a><span aria-hidden="true">/</span><span>{page.verticalLabel}</span></nav><span>Last reviewed {longDate(page.reviewedAt)} · {entries.length} firms evaluated</span></div>
